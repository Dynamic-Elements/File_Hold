...
namespace VFPToolkit
{
	...
	public class VfpData
	{
		...
		/// <returns></returns>
		public static int RecCount(DataView toView)
		{
			return toView.Count;
		}
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static string Filter(DataView toView)
		{
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static string Field(int nPosition, DataView toView)
		{
			string lcRetVal = "";
			try
			{
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static int FCount(DataView toView)
		{
		...
		/// <returns></returns>
		public static string CurVal(string tcField, DataRow toRow)
		{
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static string Order(DataView toView)
		{
			return toView.Sort;
		}
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static int Seek(string tcString, DataView toView)
		{
			int nFound = 0;
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static bool EOF(int nRowNumber, DataView toView)
		{
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static bool BOF(int nRowNumber, DataView toView)
		{
			return (nRowNumber == 0);
		}
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static bool Descending(DataView toView)
		{
		...
		/// </example>
		/// <param name="toView"></param>
		public static void Select(DataView toView)
		{
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static bool IsReadOnly(DataView toView)
		{
		...
		/// <param name="toView"></param>
		/// <returns></returns>
		public static bool Deleted(int nRecNo, DataView toView)
		{
			bool llRetVal = false;
			...
			toView.RowStateFilter = DataViewRowState.Deleted;
		...
		public static void SetFilterTo(string tcFilterExpression, DataView toView)
		{
		...
		/// <param name="toView"></param>
		public static void SetOrderTo(string tcFieldName, DataView toView)
		{
		...
		/// <returns></returns>
		public static int Count(string tcFilterCondition, DataView toView)
		{
			int nRetVal = 0;
		...
		public static int Count(DataView toView){return toView.Count;}
		...
		/// </example>
		/// <param name="toView"></param>
		public static DataRow AppendBlank(DataView toView)
		{
		...
		/// </example>
		/// <param name="toView"></param>
		public static void Browse(DataView toView)
		{
			//Create a new form
		...
		/// <param name="nPosition"></param>
		/// <param name="toView"></param>
		public static void Delete(int nRecNo, DataView toView)
		{
		...
		/// <param name="nRecNo"></param>
		/// <param name="toView"></param>
		public static void Recall(int nRecNo, DataView toView)
		{
		...
		/// <param name="toView"></param>
		public static void DeleteFor(string cExpression, DataView toView)
		{
			...
			foreach(DataRow r in toView.Table.Rows)
			{
				r.Delete();
			}
