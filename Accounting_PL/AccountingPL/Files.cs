...
namespace VFPToolkit
{
	...
	public class Files
	{
		...
		public static int AGetFileVersion(ref string[] aFileInfoArray, string cFileName)
		{
            ...
            FileVersionInfo fvi = FileVersionInfo.GetVersionInfo(cFileName);
		...
		/// </summary>
		/// <param name="oFileStream"></param>
		public static void FClose(ref FileStream oFileStream)
		{
			oFileStream.Close();
		}
		...
		/// <param name="cFileName"></param>
		/// <returns></returns>
		public static FileStream FCreate(string cFileName)
		{
			return new FileStream(cFileName, FileMode.CreateNew);
		}
		...
		/// <param name="oFileStream"></param>
		/// <returns></returns>
		public static bool FEOF(FileStream oFileStream)
		{
		...
		/// </summary>
		/// <param name="oFileStream"></param>
		public static void FFlush(FileStream oFileStream)
		{
			oFileStream.Flush();
		}
		...
		/// <param name="cFileName"></param>
		/// <returns></returns>
		public static FileStream FOpen(string cFileName)
		{
			return new FileStream(cFileName, FileMode.Open);
		}
		...
		public static long FSeek(ref FileStream oFileStream, int nBytesMoved, int nRelativePosition)
		{
			...
			{
				return oFileStream.Seek(nBytesMoved, SeekOrigin.End);
			}
			else if (nRelativePosition == 0)
			{
				return oFileStream.Seek(nBytesMoved, SeekOrigin.Begin);
			}
			else
			{
				return oFileStream.Seek(nBytesMoved, SeekOrigin.Current);
			}
		}
